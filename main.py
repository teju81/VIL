...
flags.DEFINE_string('demo_file', '/home/teju/code/python/VIL/data/vision_reach/color_data', 'path to the directory where demo files that containing robot states and actions are stored')
flags.DEFINE_string('demo_gif_dir', '/home/teju/code/python/VIL/data/vision_reach/color_data/', 'path to the videos of demonstrations')
...
flags.DEFINE_string('pretrain_weight_path', '/home/teju/code/python/VIL/data/vgg19_weights_tf_dim_ordering_tf_kernels.h5', 'path to pretrained weights or N/A')
...
flags.DEFINE_string('log_dir', '/home/teju/code/python/VIL/logs/visionreach', 'directory for summaries and checkpoints.')
